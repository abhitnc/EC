                    ...
                    <div class="card bg-secondary shadow border-0">
                            <div class="card-header bg-white pb-5">
                                <div class="btn-wrapper text-center">
                                    <h1 class="display-3 mb-0">UPDATE PASSWORD</h1>
                                </div>
                            </div>
                            ...
                            <form id="form1" runat="server">
                                ...
                                <div class="form-group">
                                    <div class="input-group input-group-alternative">
                                        ...
                                        <asp:TextBox ID="confirm1" runat="server" TextMode="Password" placeholder="Confirm Password" CssClass="form-control"></asp:TextBox>
                                    </div>
                                    <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToCompare="pass1" ControlToValidate="confirm1" ErrorMessage="Password Not Matching"></asp:CompareValidator>
                                </div>
