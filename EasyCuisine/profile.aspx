                                ...
                                <form runat="server" id="f1">
                                    <div class="form-group">
                                        <div class="input-group input-group-alternative mb-3">
                                            ...
                                            <asp:TextBox ID="name" runat="server" ReadOnly="true" placeholder="Name" CssClass="form-control"></asp:TextBox>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group input-group-alternative mb-3">
                                            ...
                                            <asp:TextBox ID="number" runat="server" ReadOnly="true" TextMode="Phone" placeholder="Phone Number" CssClass="form-control"></asp:TextBox>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group input-group-alternative mb-3">
                                            ...
                                            <asp:TextBox ID="email" runat="server" ReadOnly="true" TextMode="Email" placeholder="Email" CssClass="form-control"></asp:TextBox>
                                        </div>
                                    ...
                                    <div class="text-center">
                                        <asp:Button ID="edit" runat="server" Text="Edit" CssClass="btn btn-primary mt-4" OnClick="Unnamed_Click1" />
                                        <asp:Button ID="cancel" runat="server" Text="Cancel" CssClass="btn btn-primary mt-4" OnClick="Unnamed_Click2" />
                                    </div>
                                </form>
                            </div>
                        </div>
